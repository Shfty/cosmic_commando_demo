...
# Undocumented property hints
const PROPERTY_HINT_OBJECT_ID = 23
const PROPERTY_HINT_TYPE_STRING = 24 # a type string, the hint is the base type to choose
const PROPERTY_HINT_NODE_PATH_TO_EDITED_NODE = 25 # so something else can provide this (used in scripts)
const PROPERTY_HINT_METHOD_OF_VARIANT_TYPE = 26 # a method of a type
const PROPERTY_HINT_METHOD_OF_BASE_TYPE = 27 # a method of a base type
const PROPERTY_HINT_METHOD_OF_INSTANCE = 28 # a method of an instance
const PROPERTY_HINT_METHOD_OF_SCRIPT = 29 # a method of a script & base
const PROPERTY_HINT_PROPERTY_OF_VARIANT_TYPE = 30 # a property of a type
const PROPERTY_HINT_PROPERTY_OF_BASE_TYPE = 31 # a property of a base type
const PROPERTY_HINT_PROPERTY_OF_INSTANCE = 32 # a property of an instance
const PROPERTY_HINT_PROPERTY_OF_SCRIPT = 33 # a property of a script & base
const PROPERTY_HINT_OBJECT_TOO_BIG = 34 # object is too big to send
const PROPERTY_HINT_NODE_PATH_VALID_TYPES = 35
const PROPERTY_HINT_SAVE_FILE = 36 # a file path must be passed, hint_text (optionally) is a filter "*.png,*.wav,*.doc,". This opens a save dialog
